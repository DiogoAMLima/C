   ...
   main()
{
   ...
   setlocale(LC_ALL,"");
   strcpy(Nome, "Diogo de Albuquerque");  // scrpy = função para copiar o valor da string na segunda posição do argumento (segundo argumento pode ser: expressão em string, variável ou valor literal de uma string entre aspas "")
